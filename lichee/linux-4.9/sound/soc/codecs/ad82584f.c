...
//	{0x1b, 0x01},//##HVUV_selection - 7.2v
	{0x1b, 0x00},//##HVUV_selection - 4.0v
...
static struct ad82584f_priv *g_ad82584f = NULL;

static void ad82584f_volume_ext_work(struct work_struct *work)
{
	int reg_val, tmp, ret;
	...
	if(g_ad82584f)
	{
		...
		ret = snd_soc_write(g_ad82584f->codec, MVOL, tmp);
	}
}
...
int ad82584f_set_volume_ext(int volume)
{
	...
	if(g_ad82584f)
	{
		g_ad82584f->volume_ext = volume;

		queue_delayed_work(system_power_efficient_wq, &g_ad82584f->work, msecs_to_jiffies(50));
	}

	return 0;
}
EXPORT_SYMBOL_GPL(ad82584f_set_volume_ext);

int ad82584f_get_volume_ext(void)
{
	if(g_ad82584f)
	{
		return g_ad82584f->volume_ext;
	}

	return 0;
}
EXPORT_SYMBOL_GPL(ad82584f_get_volume_ext);
...
static int ad82584f_init(struct snd_soc_codec *codec)
{
	...
	g_ad82584f = ad82584f;
	g_ad82584f->codec = codec;

	INIT_DELAYED_WORK(&g_ad82584f->work, ad82584f_volume_ext_work);
	return 0;
}
	...
	struct device_node *np)
{
	...
	amp_en = of_get_named_gpio_flags(np, "amp_en", 0,
