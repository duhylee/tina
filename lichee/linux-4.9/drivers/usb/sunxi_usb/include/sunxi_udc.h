...
// jh.lee@reigncomtech.com - fixed for support USB Audio Class 2.0 test [2022/08/04]
#define USE_SUPPORT_UAC2_TEST
...
#ifdef USE_SUPPORT_UAC2_TEST
static const char ep4_iso_name[]     = "ep4-iso";
static const char ep5_int_name[]     = "ep5-int";
#else
...
#ifdef USE_SUPPORT_UAC2_TEST	
	{ep3_iso_name,     2560, 512,  0},  // playback - 0.5k, max 48KHz 32bit 2ch ...
    {ep4_iso_name,     3072, 768,  0},  // capture - 0.75k, max 16KHz 32bit 10ch ...
	{ep5_int_name,     3840, 256,  0},  
#else
...
#ifdef USE_SUPPORT_UAC2_TEST	
static const int ep_fifo_out[] = {0, 2, 4, 5, 6, 7};
#else
