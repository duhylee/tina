...
if [ "x${PACK_CHIP}" = "xsun5i" ]; then
	...
	PACK_BOARD_PLATFORM=${PACK_BOARD%%-*}
	ARCH=arm
elif [ "x${PACK_CHIP}" = "xsun50iw6p1" ]; then
	PACK_BOARD_PLATFORM=${PACK_BOARD%%-*}
	ARCH=arm64
else
...
boot_file_list=(
${TINA_CONFIG_DIR}/${PACK_BOARD_PLATFORM}-common/bin/boot0_nand_${PACK_CHIP}.bin:image/boot0_nand.fex
${TINA_CONFIG_DIR}/${PACK_BOARD_PLATFORM}-common/bin/boot0_sdcard_${PACK_CHIP}.bin:image/boot0_sdcard.fex
${TINA_CONFIG_DIR}/${PACK_BOARD_PLATFORM}-common/bin/boot0_spinor_${PACK_CHIP}.bin:image/boot0_spinor.fex
${TINA_CONFIG_DIR}/${PACK_BOARD_PLATFORM}-common/bin/fes1_${PACK_CHIP}.bin:image/fes1.fex
${TINA_CONFIG_DIR}/${PACK_BOARD_PLATFORM}-common/bin/u-boot-${PACK_CHIP}.bin:image/u-boot.fex
${TINA_CONFIG_DIR}/${PACK_BOARD_PLATFORM}-common/bin/u-boot-crashdump-${PACK_CHIP}.bin:image/u-boot-crash.fex
${TINA_CONFIG_DIR}/${PACK_BOARD_PLATFORM}-common/bin/u-boot-crashdump-spinor-${PACK_CHIP}.bin:image/u-boot-spinor-crash.fex
${TINA_CONFIG_DIR}/${PACK_BOARD_PLATFORM}-common/bin/bl31.bin:image/monitor.fex
${TINA_CONFIG_DIR}/${PACK_BOARD_PLATFORM}-common/bin/scp.bin:image/scp.fex
${TINA_CONFIG_DIR}/${PACK_BOARD_PLATFORM}-common/bin/optee_${PACK_CHIP}.bin:image/optee.fex
${TINA_CONFIG_DIR}/${PACK_BOARD_PLATFORM}-common/bin/u-boot-spinor-${PACK_CHIP}.bin:image/u-boot-spinor.fex
${TINA_CONFIG_DIR}/${PACK_BOARD_PLATFORM}-common/bin/boot0_nand_${PACK_CHIP}-${OTA_TEST_NAME}.bin:image/boot0_nand-${OTA_TEST_NAME}.fex
${TINA_CONFIG_DIR}/${PACK_BOARD_PLATFORM}-common/bin/boot0_sdcard_${PACK_CHIP}-${OTA_TEST_NAME}.bin:image/boot0_sdcard-${OTA_TEST_NAME}.fex
${TINA_CONFIG_DIR}/${PACK_BOARD_PLATFORM}-common/bin/boot0_spinor_${PACK_CHIP}-${OTA_TEST_NAME}.bin:image/boot0_spinor-${OTA_TEST_NAME}.fex
${TINA_CONFIG_DIR}/${PACK_BOARD_PLATFORM}-common/bin/u-boot-${PACK_CHIP}-${OTA_TEST_NAME}.bin:image/u-boot-${OTA_TEST_NAME}.fex
${TINA_CONFIG_DIR}/${PACK_BOARD_PLATFORM}-common/bin/u-boot-spinor-${PACK_CHIP}-${OTA_TEST_NAME}.bin:image/u-boot-spinor-${OTA_TEST_NAME}.fex

${TINA_CONFIG_DIR}/${PACK_BOARD}/bin/boot0_nand_${PACK_CHIP}.bin:image/boot0_nand.fex
${TINA_CONFIG_DIR}/${PACK_BOARD}/bin/boot0_sdcard_${PACK_CHIP}.bin:image/boot0_sdcard.fex
${TINA_CONFIG_DIR}/${PACK_BOARD}/bin/boot0_spinor_${PACK_CHIP}.bin:image/boot0_spinor.fex
${TINA_CONFIG_DIR}/${PACK_BOARD}/bin/fes1_${PACK_CHIP}.bin:image/fes1.fex
${TINA_CONFIG_DIR}/${PACK_BOARD}/bin/u-boot-${PACK_CHIP}.bin:image/u-boot.fex
${TINA_CONFIG_DIR}/${PACK_BOARD}/bin/u-boot-crashdump-${PACK_CHIP}.bin:image/u-boot-crash.fex
${TINA_CONFIG_DIR}/${PACK_BOARD}/bin/u-boot-crashdump-spinor-${PACK_CHIP}.bin:image/u-boot-spinor-crash.fex
${TINA_CONFIG_DIR}/${PACK_BOARD}/bin/bl31.bin:image/monitor.fex
${TINA_CONFIG_DIR}/${PACK_BOARD}/bin/scp.bin:image/scp.fex
${TINA_CONFIG_DIR}/${PACK_BOARD}/bin/optee_${PACK_CHIP}.bin:image/optee.fex
${TINA_CONFIG_DIR}/${PACK_BOARD}/bin/u-boot-spinor-${PACK_CHIP}.bin:image/u-boot-spinor.fex
${TINA_CONFIG_DIR}/${PACK_BOARD}/bin/boot0_nand_${PACK_CHIP}-${OTA_TEST_NAME}.bin:image/boot0_nand-${OTA_TEST_NAME}.fex
${TINA_CONFIG_DIR}/${PACK_BOARD}/bin/boot0_sdcard_${PACK_CHIP}-${OTA_TEST_NAME}.bin:image/boot0_sdcard-${OTA_TEST_NAME}.fex
${TINA_CONFIG_DIR}/${PACK_BOARD}/bin/boot0_spinor_${PACK_CHIP}-${OTA_TEST_NAME}.bin:image/boot0_spinor-${OTA_TEST_NAME}.fex
${TINA_CONFIG_DIR}/${PACK_BOARD}/bin/u-boot-${PACK_CHIP}-${OTA_TEST_NAME}.bin:image/u-boot-${OTA_TEST_NAME}.fex
${TINA_CONFIG_DIR}/${PACK_BOARD}/bin/u-boot-spinor-${PACK_CHIP}-${OTA_TEST_NAME}.bin:image/u-boot-spinor-${OTA_TEST_NAME}.fex

${LONGAN_CONFIG_DIR}/../bin/boot0_nand_${PACK_CHIP}.bin:image/boot0_nand.fex
${LONGAN_CONFIG_DIR}/../bin/boot0_sdcard_${PACK_CHIP}.bin:image/boot0_sdcard.fex
${LONGAN_CONFIG_DIR}/../bin/boot0_spinor_${PACK_CHIP}.bin:image/boot0_spinor.fex
${LONGAN_CONFIG_DIR}/../bin/fes1_${PACK_CHIP}.bin:image/fes1.fex
${LONGAN_CONFIG_DIR}/../bin/u-boot-${PACK_CHIP}.bin:image/u-boot.fex
${LONGAN_CONFIG_DIR}/../bin/u-boot-crashdump-${PACK_CHIP}.bin:image/u-boot-crash.fex
${LONGAN_CONFIG_DIR}/../bin/u-boot-crashdump-spinor-${PACK_CHIP}.bin:image/u-boot-spinor-crash.fex
${LONGAN_CONFIG_DIR}/../bin/bl31.bin:image/monitor.fex
${LONGAN_CONFIG_DIR}/../bin/scp.bin:image/scp.fex
...
${LONGAN_CONFIG_DIR}/../bin/boot0_nand_${PACK_CHIP}-${OTA_TEST_NAME}.bin:image/boot0_nand-${OTA_TEST_NAME}.fex
${LONGAN_CONFIG_DIR}/../bin/boot0_sdcard_${PACK_CHIP}-${OTA_TEST_NAME}.bin:image/boot0_sdcard-${OTA_TEST_NAME}.fex
${LONGAN_CONFIG_DIR}/../bin/boot0_spinor_${PACK_CHIP}-${OTA_TEST_NAME}.bin:image/boot0_spinor-${OTA_TEST_NAME}.fex
${LONGAN_CONFIG_DIR}/../bin/u-boot-${PACK_CHIP}-${OTA_TEST_NAME}.bin:image/u-boot-${OTA_TEST_NAME}.fex
${LONGAN_CONFIG_DIR}/../bin/u-boot-spinor-${PACK_CHIP}-${OTA_TEST_NAME}.bin:image/u-boot-spinor-${OTA_TEST_NAME}.fex

${LONGAN_CONFIG_DIR}/${PACK_BOARD#*-}/bin/boot0_nand_${PACK_CHIP}.bin:image/boot0_nand.fex
${LONGAN_CONFIG_DIR}/${PACK_BOARD#*-}/bin/boot0_sdcard_${PACK_CHIP}.bin:image/boot0_sdcard.fex
${LONGAN_CONFIG_DIR}/${PACK_BOARD#*-}/bin/boot0_spinor_${PACK_CHIP}.bin:image/boot0_spinor.fex
${LONGAN_CONFIG_DIR}/${PACK_BOARD#*-}/bin/fes1_${PACK_CHIP}.bin:image/fes1.fex
${LONGAN_CONFIG_DIR}/${PACK_BOARD#*-}/bin/u-boot-${PACK_CHIP}.bin:image/u-boot.fex
${LONGAN_CONFIG_DIR}/${PACK_BOARD#*-}/bin/u-boot-crashdump-${PACK_CHIP}.bin:image/u-boot-crash.fex
${LONGAN_CONFIG_DIR}/${PACK_BOARD#*-}/bin/u-boot-crashdump-spinor-${PACK_CHIP}.bin:image/u-boot-spinor-crash.fex
${LONGAN_CONFIG_DIR}/${PACK_BOARD#*-}/bin/bl31.bin:image/monitor.fex
${LONGAN_CONFIG_DIR}/${PACK_BOARD#*-}/bin/scp.bin:image/scp.fex
${LONGAN_CONFIG_DIR}/${PACK_BOARD#*-}/bin/optee_${PACK_CHIP}.bin:image/optee.fex
${LONGAN_CONFIG_DIR}/${PACK_BOARD#*-}/bin/u-boot-spinor-${PACK_CHIP}.bin:image/u-boot-spinor.fex
${LONGAN_CONFIG_DIR}/${PACK_BOARD#*-}/bin/boot0_nand_${PACK_CHIP}-${OTA_TEST_NAME}.bin:image/boot0_nand-${OTA_TEST_NAME}.fex
${LONGAN_CONFIG_DIR}/${PACK_BOARD#*-}/bin/boot0_sdcard_${PACK_CHIP}-${OTA_TEST_NAME}.bin:image/boot0_sdcard-${OTA_TEST_NAME}.fex
${LONGAN_CONFIG_DIR}/${PACK_BOARD#*-}/bin/boot0_spinor_${PACK_CHIP}-${OTA_TEST_NAME}.bin:image/boot0_spinor-${OTA_TEST_NAME}.fex
${LONGAN_CONFIG_DIR}/${PACK_BOARD#*-}/bin/u-boot-${PACK_CHIP}-${OTA_TEST_NAME}.bin:image/u-boot-${OTA_TEST_NAME}.fex
${LONGAN_CONFIG_DIR}/${PACK_BOARD#*-}/bin/u-boot-spinor-${PACK_CHIP}-${OTA_TEST_NAME}.bin:image/u-boot-spinor-${OTA_TEST_NAME}.fex
